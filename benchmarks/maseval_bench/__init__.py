"""Spike: benchmarking mfca through MASEval instead of the hand-rolled test_runner.py harness.

MASEval (github.com/parameterlab/MASEval, ACL 2026) is a framework-agnostic
multi-agent evaluation library. This spike wraps mfca as a MASEval AgentAdapter
